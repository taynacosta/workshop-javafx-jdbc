...
public class SellerFormController implements Initializable {
	...
	/*public void setServices(SellerService service, DepartmentService departmenService) {
	...
	private Seller getFormData() {
		...
		if (txtName.getText() == null || txtName.getText().trim().contentEquals("")) { // trim = ignora espaços vazios
	...
	public void onBtCancelAction(ActionEvent event) {
		Utils.currentStage(event).close(); // currentStage = chama a janela atual
	}
